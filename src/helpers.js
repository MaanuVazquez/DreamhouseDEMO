...
const controller = {
  ...
  propertiesWithProbabilities: [],
	...
	initialize() {
		return new Promise(async (resolve, reject) => {
			try {
        const data = await db.query('SELECT * FROM salesforce.broker__c');
        ...
        resolve(true);
				...
				try {
					const broker = await db.query('SELECT * FROM broker__c');
          resolve(true);
				} catch(e) {
	...
	async createDB() {
    try {
      await db.query(`CREATE TABLE broker__c (
           id SERIAL NOT NULL,
      ...
      await db.query(`CREATE TABLE property__c (
       id SERIAL NOT NULL,
       sfid CHARACTER VARYING(18) UNIQUE,
       name CHARACTER VARYING(80),
      ...
      await db.query(`CREATE TABLE favorite__c (
       id SERIAL NOT NULL,
       sfid CHARACTER VARYING(18) UNIQUE,
       property__c CHARACTER VARYING(18) REFERENCES property__c(sfid)
      );`);

      await db.query(`INSERT INTO broker__c (email__c, phone__c, name, mobile_phone__c, sfid, title__c, picture__c) VALUES ('caroline@ionicrealty.com', '617-244-3672', 'Caroline Kingsley', '617-244-3672', 'a0036000003SsJwAAK', 'Senior Broker', 'https://s3-us-west-1.amazonaws.com/sfdc-demo/people/caroline_kingsley.jpg');`);
      await db.query(`INSERT INTO broker__c (email__c, phone__c, name, mobile_phone__c, sfid, title__c, picture__c) VALUES ('jen@ionicrealty.com', '617-244-3672', 'Jennifer Wu', '617-244-3672', 'a0036000003SsJzAAK', 'Senior Broker', 'https://s3-us-west-1.amazonaws.com/sfdc-demo/people/jennifer_wu.jpg');`);
      await db.query(`INSERT INTO broker__c (email__c, phone__c, name, mobile_phone__c, sfid, title__c, picture__c) VALUES ('michael@ionicrealty.com', '617-244-3672', 'Michael Jones', '617-244-3672', 'a0036000003SsJxAAK', 'Senior Broker', 'https://s3-us-west-1.amazonaws.com/sfdc-demo/people/michael_jones.jpg');`);
      await db.query(`INSERT INTO broker__c (email__c, phone__c, name, mobile_phone__c, sfid, title__c, picture__c) VALUES ('michelle@ionicrealty.com', '617-244-3672', 'Michelle Lambert', '617-244-3672', 'a0036000003SsK2AAK', 'Senior Broker', 'https://s3-us-west-1.amazonaws.com/sfdc-demo/people/michelle_lambert.jpg');`);
      await db.query(`INSERT INTO broker__c (email__c, phone__c, name, mobile_phone__c, sfid, title__c, picture__c) VALUES ('jonathan@ionicrealty.com', '617-244-3672', 'Jonathan Bradley', '617-244-3672', 'a0036000003SsJyAAK', 'Senior Broker', 'https://s3-us-west-1.amazonaws.com/sfdc-demo/people/jonathan_bradley.jpg');`);
      await db.query(`INSERT INTO broker__c (email__c, phone__c, name, mobile_phone__c, sfid, title__c, picture__c) VALUES ('olivia@ionicrealty.com', '617-244-3672', 'Olivia Green', '617-244-3672', 'a0036000003SsK0AAK', 'Senior Broker', 'https://s3-us-west-1.amazonaws.com/sfdc-demo/people/olivia_green.jpg');`);
      await db.query(`INSERT INTO broker__c (email__c, phone__c, name, mobile_phone__c, sfid, title__c, picture__c) VALUES ('miriam@ionicrealty.com', '617-244-3672', 'Miriam Aupont', '617-244-3672', 'a0036000003SsK1AAK', 'Senior Broker', 'https://s3-us-west-1.amazonaws.com/sfdc-demo/people/miriam_aupont.jpg');`);
      await db.query(`INSERT INTO broker__c (email__c, phone__c, name, mobile_phone__c, sfid, title__c, picture__c) VALUES ('victor@ionicrealty.com', '617-244-3672', 'Victor Ochoa', '617-244-3672', 'a0036000003SsK3AAK', 'Senior Broker', 'https://s3-us-west-1.amazonaws.com/sfdc-demo/people/victor_ochoa.jpg');`);
      await db.query(`INSERT INTO property__c (name, thumbnail__c, beds__c, location__longitude__s, address__c, baths__c, broker__c, description__c, sfid, state__c, city__c, zip__c, title__c, picture__c, price__c, location__latitude__s) VALUES ('18 Henry st', 'https://s3-us-west-1.amazonaws.com/sfdc-demo/realty/house01sq.jpg', 4, -71.1109500000000025, '18 Henry st', 3, 'a0036000003SsJwAAK', 'Lorem ipsum dolor sit amet', 'a0236000002NHKoAAO', 'MA', 'Cambridge', '01742', 'Stunning Victorian', 'https://s3-us-west-1.amazonaws.com/sfdc-demo/realty/house01.jpg', 975000, 42.3566300000000027);`);
      ...
      await db.query(`INSERT INTO favorite__c (property__c, sfid) VALUES ('a0236000002NHKoAAO', 'a0136000003SsewAAC');`);
  ...
  getAllProperties() {
    return new Promise(async (resolve, reject) => {
      try {
      const data = await db.query('SELECT * FROM ' + controller.propertyTable);
      resolve(data.rows);
      } catch(e) {
        reject(e);
      };
